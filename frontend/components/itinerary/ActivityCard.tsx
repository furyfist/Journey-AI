    ...
    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-4 flex flex-col gap-2">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-medium text-[var(--text-primary)] leading-snug">{activity.name}</p>
          <p className="text-sm text-[var(--text-muted)] mt-0.5">{activity.location}</p>
      ...
      <Accordion>
        <AccordionItem value="why-this" className="border-0">
          <AccordionTrigger className="text-xs text-[var(--text-muted)] font-normal hover:no-underline py-1">
            Why This?
          </AccordionTrigger>
